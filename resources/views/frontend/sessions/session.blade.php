    ...
    <div class='col-md-12'>
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <span class="custom-span-x2"><i class="fa fa-music fa-fw fa-orange"></i>{{$session->sessionGenre->name}}</span>
                <span class="custom-span-x2"><i class="fa fa-user fa-fw fa-orange"></i>{{$session->user->name}}</span>
